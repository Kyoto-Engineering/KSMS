...
namespace KyotoSalesManagementSystem.UI
{
    ...
    public partial class QuotationMMix : Form
    {
        ...
        public decimal dmaount = 0, lTAmount = 0, subAmount = 0, takeRemovePric = 0, takeRemoveQuantity = 0, takeRemove = 0, takeRemove2 = 0, presentTotalPrice = 0, tPrice = 0, taxPercent = 0, dmaount2 = 0, lTAmount2 = 0, txVatAmount;
       ...
       public void GetData()
        ...
        private void QuotationMMix_Load(object sender, EventArgs e)
        {
            GetData();
            ...
            checkBox1.Location = new Point(groupBox8.Location.X + 13, groupBox8.Location.Y - 1);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else if (checkBox1.Checked && listView3.Items.Count < 1)
            {
                MessageBox.Show("Insert Additional Items Or Untick Check Box", "Input Error",
                  MessageBoxButtons.OK, MessageBoxIcon.Error);
                checkBox1.Focus();
            }
        ...
        private void CalculateTotalAmount2()
        {
            try
            {
                dmaount2 = Convert.ToDecimal(textBox2.Text);
                lTAmount2 = subAmount + dmaount2;
                txtTotalPrice.Text = lTAmount2.ToString();
                subAmount = lTAmount2;
        ...
        private void Reset()
        {
            ...
            dmaount2 = lTAmount2=dmaount = lTAmount = subAmount = takeRemove = takeRemove2 = presentTotalPrice = tPrice = taxPercent = 0;
        ...
        private void QuotationMMix_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose();
            MainUI frm = new MainUI();
            frm.Show();
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter  Order Quantity", "error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                textBox3.Focus();
            }
        ...
        private void textBox4_TextChanged(object sender, EventArgs e)
        {
            ...
            decimal.TryParse(textBox4.Text, out val2);
            decimal I = (val1 * val2);
            textBox2.Text = I.ToString();

        }

        private void txtQuotQuantity_Enter(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(txtUnitPrice.Text))
            {
                MessageBox.Show("You Can Enter Quantity Until You Select A product", "error", MessageBoxButtons.OK,
                    MessageBoxIcon.Stop);
                dataGridView1.Focus();
            }
        }
        ...
        {
            if (string.IsNullOrWhiteSpace(txtQuotQuantity.Text))
            {
                MessageBox.Show("You Can Enter  Minimum Order Quantity Until You Enter A Quantity", "error", MessageBoxButtons.OK,
                    MessageBoxIcon.Stop);
                txtQuotQuantity.Focus();
            }
        }
        ...
        {
            if (!checkBox1.Checked  && listView3.Items.Count<1)
            {
            ...
            else if (checkBox1.Checked && listView3.Items.Count > 0)
            {
                MessageBox.Show("You Can not untick the Check box now you have to first remove the items","Error",MessageBoxButtons.OK,MessageBoxIcon.Stop);
                listView3.Focus();
            }
        }
        ...
        {
            takeRemovePric = Convert.ToDecimal(listView3.SelectedItems[0].SubItems[2].Text);
            takeRemoveQuantity = Convert.ToDecimal(listView3.SelectedItems[0].SubItems[3].Text);
            takeRemove = (takeRemoveQuantity * takeRemovePric);
            subAmount = subAmount - takeRemove;
            takeRemove2 = Convert.ToDecimal(txtTotalPrice.Text);
            presentTotalPrice = subAmount;
